...
In the Swagger console locate the tab with the ![](../../../.gitbook/assets/image%20%284%29.png) button. The `collection` parameter should be set to `reporting` and the body should contain the **entire contents** of the new reporting relationship.
