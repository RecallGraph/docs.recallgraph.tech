...
{% content-ref url="../../understanding-recallgraph/concepts.md" %}
[concepts.md](../../understanding-recallgraph/concepts.md)
{% endcontent-ref %}

{% content-ref url="../../understanding-recallgraph/terminology/" %}
[terminology](../../understanding-recallgraph/terminology/)
{% endcontent-ref %}
...
{% content-ref url="persisting-documents/" %}
[persisting-documents](persisting-documents/)
{% endcontent-ref %}

{% content-ref url="analyzing-the-event-log/" %}
[analyzing-the-event-log](analyzing-the-event-log/)
{% endcontent-ref %}

{% content-ref url="navigating-history/" %}
